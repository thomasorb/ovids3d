...
class ThreeAxisGrid:
    def __init__(self, xsize = 50, ysize = 50, zsize = 50,
                 gridstep = 10, subdiv = 1, alpha=0.2):
        ...
        self.XAxisColor = VBase4(1, 1, 1, 1) * alpha
        self.YAxisColor = VBase4(1, 1, 1, 1) * alpha
        self.ZAxisColor = VBase4(1, 1, 1, 1) * alpha
        self.gridColor = VBase4(1, 1, 1, alpha) 
        self.subdivColor = VBase4(1, 1, 1, alpha) 

        #Line thicknesses (in pixels)
        self.axisThickness = 1.1
        self.gridThickness = 1.1
        self.subdivThickness = 1.1
    ...
    def create(self):
        ...
        self.parentNodePath.setTransparency(True)
        self.parentNodePath.setLightOff(True)
        self.parentNodePath.setShaderAuto(True)
